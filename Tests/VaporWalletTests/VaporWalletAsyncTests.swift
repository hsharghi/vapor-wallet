...
class VaporWalletAsyncTests: XCTestCase {
    ...
    func testMultiModelWallet() throws {
        ...
        let balance1 = try repo1.balance().wait()
        let balance2 = try repo2.balance().wait()
    ...
    private func migrations(_ app: Application) throws {
        // Initial Migrations
        app.migrations.add(CreateUserAsync())
        app.migrations.add(CreateGameAsync())
